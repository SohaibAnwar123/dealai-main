...
import laptop from '../../../assets/images/laptopfinal.png';
...
const HeroSection = () => {
  ...
  const [videoReady, setVideoReady] = useState(false); // State to track if video is ready to play
  ...
  return (
    <section className="heroWrap">
      <div className="container">
        <div className="heroInner">
          <div className="heroContent" data-aos="fade-up">
            ...
            {/* <a href="#" className="customBtn flex_align" data-aos="fade-up" onClick={handleShow}>
      ...
      <Modal className="heroModal" show={show} onHide={handleClose} onEntered={handleVideoReady}>
